<?php
    ...
    if($user->Is_Loggedin() != true)
    {
        ...
        try{
        $id=($_GET['id']);
        $sql = $conn->prepare("SELECT * FROM actividades WHERE ID_ACTIVIDAD= :ID");
	...
	if(isset($_REQUEST['save_actividad'])){
	try{
                        ...
                        <div class="row ">
                            <div class="col-sm-6 col-sm-offset-3" >
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <br><button type="submit" class="btn btn-primary btn-md" name="save_actividad">Guardar <span class="fa fa-save"></span></button>
                                </div>
                                </div>
                            </div>
                        </div>
