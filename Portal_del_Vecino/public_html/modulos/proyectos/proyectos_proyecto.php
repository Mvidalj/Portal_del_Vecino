	    ...
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="dropdown">
	          ...
	          <ul class="dropdown-menu">
	            <li><a href="../actividades/actividades_reuniones.html">Reuniones</a></li>
	            <li><a href="../actividades/actividades_historial.html">Historial de Actividades</a></li>
	        ...
	        <li class="dropdown active">
	          ...
	          <ul class="dropdown-menu">
	            <li class="active"><a href="proyectos_proyecto.html">Proyectos</a></li>
